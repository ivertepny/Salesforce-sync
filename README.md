# Salesforce-sync-project
Salesforce sync Project Repo

**Project Vision Statement:**

*"Connect two-way Salesforce with Ads services (Google Analytics, Google Ads, X Ads (Twitter), Facebook ads (meta), Microsoft Ads (Bing)."*
